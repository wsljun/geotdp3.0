package com.geotdb.compile.offlinemap;
...
//						Toast.LENGTH_SHORT).show()
                    ToastUtil.showToastS(OfflineMapActivity.this, (String) msg.obj);
                    break;
...
//		initDialog();
    ...
    private void init() {
        ...
        back_image = (ImageView) findViewById(R.id.back_image_view);
    ...
    public void initAllCityList() {
        ...
        mAllOfflineMapList.setDivider(new ColorDrawable(Color.GRAY));
        mAllOfflineMapList.setDividerHeight(1);
    ...
    private void logList() {
        ...
        for (OfflineMapCity offlineMapCity : list) {
            L.i("amap-city-loading: ", offlineMapCity.getCity() + "," + offlineMapCity.getState());
        }
        ArrayList<OfflineMapCity> list1 = amapManager.getDownloadOfflineMapCityList();
        for (OfflineMapCity offlineMapCity : list1) {
            L.i("amap-city-loaded: ", offlineMapCity.getCity() + "," + offlineMapCity.getState());
        }
    }
    ...
    public void onDownload(int status, int completeCode, String downName) {
        ...
        switch (status) {
            ...
            case OfflineMapStatus.LOADING:
                L.d("amap-download", "download: " + completeCode + "%" + "," + downName);
                // changeOfflineMapTitle(OfflineMapStatus.LOADING, downName);
                break;
            case OfflineMapStatus.UNZIP:
                L.d("amap-unzip", "unzip: " + completeCode + "%" + "," + downName);
                // changeOfflineMapTitle(OfflineMapStatus.UNZIP);
                // changeOfflineMapTitle(OfflineMapStatus.UNZIP, downName);
                break;
            case OfflineMapStatus.WAITING:
                L.d("amap-waiting", "WAITING: " + completeCode + "%" + "," + downName);
                break;
            case OfflineMapStatus.PAUSE:
                L.d("amap-pause", "pause: " + completeCode + "%" + "," + downName);
                break;
            case OfflineMapStatus.STOP:
                break;
            case OfflineMapStatus.ERROR:
                L.e("amap-download", "download: " + " ERROR " + downName);
                break;
            case OfflineMapStatus.EXCEPTION_AMAP:
                L.e("amap-download", "download: " + " EXCEPTION_AMAP " + downName);
                break;
            case OfflineMapStatus.EXCEPTION_NETWORK_LOADING:
                L.e("amap-download", "download: " + " EXCEPTION_NETWORK_LOADING " + downName);
                Toast.makeText(OfflineMapActivity.this, "网络异常", Toast.LENGTH_SHORT).show();
                amapManager.pause();
                break;
            case OfflineMapStatus.EXCEPTION_SDCARD:
                L.e("amap-download", "download: " + " EXCEPTION_SDCARD " + downName);
                break;
            default:
                break;
        }
    ...
    public void onCheckUpdate(boolean hasNew, String name) {
        L.i("amap-demo", "onCheckUpdate " + name + " : " + hasNew);
    ...
    public void onRemove(boolean success, String name, String describe) {
        L.i("amap-demo", "onRemove " + name + " : " + success + " , " + describe);
        handler.sendEmptyMessage(UPDATE_LIST);
        Message message = new Message();
        message.what = SHOW_MSG;
