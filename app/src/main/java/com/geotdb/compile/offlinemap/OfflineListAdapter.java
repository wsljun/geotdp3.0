...
//		return provinceList.get(groupPosition).getCityList().get(childPosition).getCity();
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        if (isOpen[groupPosition]) {
            group_image.setImageDrawable(mContext.getResources().getDrawable(R.drawable.ai_icon_unfold));
        } else {
            group_image.setImageDrawable(mContext.getResources().getDrawable(R.drawable.ai_icon_fold));
        }
        return convertView;
    }
